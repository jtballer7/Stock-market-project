...
import { config } from '../investment-app/config.js';
...
const adapter = new JSONFile(path.join(__dirname, '../investment-app/db.json'));
...
app.use(express.static(path.join(__dirname, '../investment-app/public')));
...
app.get('/', (req, res) => {
    res.sendFile(path.join(__dirname, '../investment-app/public', '/app/main/', 'home.html'));
});
...
let stockPriceCache = {};
const CACHE_FILE = path.join(__dirname, '../investment-app/stock_price_cache.json');
